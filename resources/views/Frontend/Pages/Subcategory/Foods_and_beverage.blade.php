    ...
    <div class="row">
        ...
        <div class="col-md-9 bg-white">
            <div class="row bg-light mb-2">
                <span>Home ></span><span>Vegetables, Fruits, Grains, Dairy Products & Other FMCG and Grocery Items</span>
            </div>
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="">
                        <p class="text-primary">Milk & Dairy Products</p>
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <a href="">
                        <p class="text-primary">Bakery & Confectionery Products</p>
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{URL::to('frontend/img/oven.jpg')}}" height="100%" width="100%" class="img-fluid">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="">
                        <p class="text-primary">Chocolates, Biscuits & Cookies </p>
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{URL::to('frontend/img/oven.jpg')}}" height="100%" width="100%" class="img-fluid">
                            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="">
                        <p class="text-primary">Dry Fruits & Nuts</p>
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{URL::to('frontend/img/oven.jpg')}}" height="100%" width="100%" class="img-fluid">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="">
                        <p class="text-primary">Meats & Poultry Food</p>
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{URL::to('frontend/img/oven.jpg')}}" height="100%" width="100%" class="img-fluid">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="">
                        <p class="text-primary"> Hard Drinks</p>
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{URL::to('frontend/img/oven.jpg')}}" height="100%" width="100%" class="img-fluid">
                            </div>
